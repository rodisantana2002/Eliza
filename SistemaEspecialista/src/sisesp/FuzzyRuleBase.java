...
public class FuzzyRuleBase implements RuleBase {
  ...
  private Hashtable variableList = new Hashtable();  // List of all variables

  // Lists of rules
  private int ruleId = FuzzyDefs.RuleIdInitial;  // Unique Id of next rule
  private Vector ruleList = new Vector();        // List of all rules
  private Vector cndRuleList = new Vector();     // List of conditional rules
  private Vector uncRuleList = new Vector();  // Sequence of unconditional rules
  ...
  public void forwardChain() {
     // reset all rules, variables keep values set by user
      ...
      while (enums.hasMoreElements()) {
        ((FuzzyRule) (enums.nextElement())).reset();
      }
  ...
  public void reset() {
    ...
    while (enums.hasMoreElements()) {
      ((FuzzyRuleVariable) (enums.nextElement())).reset();
    }
    enums = ruleList.elements();
    while (enums.hasMoreElements()) {
      ((FuzzyRule) (enums.nextElement())).reset();
    }
  }
  ...
  private void processAssertionRules(BitSet factBase) {
    ...
    Enumeration enums= uncRuleList.elements();

    while (enums.hasMoreElements()) {
      FuzzyRule rule = (FuzzyRule) (enums.nextElement());
  ...
  private void processConditionalRules(BitSet factBase) {
    ...
    while (moreRules) {
      ...
      Enumeration enums = cndRuleList.elements();
  ...
  public void displayVariables(JTextArea textArea) {
    ...
    while (enums.hasMoreElements()) {
      FuzzyRuleVariable temp = (FuzzyRuleVariable) enums.nextElement();
  ...
  public void displayRules(JTextArea textArea) {
    ...
    while (enums.hasMoreElements()) {
      FuzzyRule temp = (FuzzyRule) enums.nextElement();
