...
public class RuleFrame extends JFrame {
    ...
    private void initInvestimentosRuleBase(BooleanRuleBase rb) {
        ...
        RuleVariable idade = new RuleVariable(rb, "idade");
        ...
        ticket.setLabels("0-100 101-1000 10000-100000 500000-1000000");
        ...
        experiencia.setLabels("nenhuma basica razoavel avancada");
        experiencia.setPromptText("Qual a sua experiencia como investidor?");
        
        RuleVariable valor_mensal = new RuleVariable(rb, "valor-mensal");
        valor_mensal.setLabels("0-100 101-1000 10000-100000 500000-1000000");
        valor_mensal.setPromptText("Qual o valor mensal que vc poderá contribuir para seu investimento?");
        ...
        objetivo.setLabels("acumular-patrimonio aposentadoria compra-bens casamento viagem educacao-filhos");
...
//                new Clause(vehicleType, cEquals, "automobile"));
    ...
    private void demoInvestimentosFC(BooleanRuleBase rb) {
        ...
        rb.setVariableValue("valor-mensal", "0-100");
        rb.setVariableValue("liquidez", "imediato");        
        rb.setVariableValue("objetivo", "compra-bens");        
     ...
     *
     * @param e the ActionEvent object generated when the vehicles button was
     * clicked
     *
     */
     ...
     *
     * @param e the ActionEvent object generated when the bugs button was
     * clicked
     *
     */
     ...
     *
     * @param e the ActionEvent object generated when the plants button was
     * clicked
     *
     */
     ...
     *
     * @param e the ActionEvent object generated when the motor button was
     * clicked
     *
     */
