...
public class clsTrataDatas {
   ...
   public boolean isDate(String strData){
       ...
       catch(IllegalFormatConversionException exIFE){System.out.println("formato da data invalida" + " - " + exIFE.getMessage());}
       catch(NumberFormatException exNFE){System.out.println("formato da data invalida" + " - " + exNFE.getMessage());}
       return false;
   }
   ...
   public boolean isDateMaior(String strDataInicio, String strDataFim){
       ...
       Date dtFim  = new Date();
       try{
           dtInicio = formatIso.parse(strDataInicio);
           dtFim = formatIso.parse(strDataFim);
           if (dtInicio.after(dtFim)){
               return true;
           }
       }    
       //algo de errado com a data       
       catch(ParseException exNFE){System.out.println("formato da data invalida" + " - " + exNFE.getMessage());}       
       return false;
   }
